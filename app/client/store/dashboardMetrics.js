...
export const DASHBOARD_METRICS = {
  ...
  forceCurve: { displayName: 'Force curve', size: 2, template: (metrics) => html`<dashboard-force-curve .forceCurveData=${{ updateForceCurve: metrics.metricsContext?.isRecoveryStart, value: metrics?.driveHandleForceCurve }} style="grid-column: span 2"></dashboard-force-curve>` },
