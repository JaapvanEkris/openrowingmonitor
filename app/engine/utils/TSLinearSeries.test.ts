...
describe('Edge-cases', () => {
  test('Edge_01: Series with 5 elements, all with the same result, y = 6', () => {
    const dataSeries = createTSLinearSeries(5)
    dataSeries.push(1, 6)
    dataSeries.push(2, 6)
    dataSeries.push(3, 6)
  ...
  test('Edge_02: Series with 5 elements, all with the same result, x = 6', () => {
    const dataSeries = createTSLinearSeries(5)
    dataSeries.push(6, 1)
    dataSeries.push(6, 2)
    dataSeries.push(6, 3)
  ...
  test('Edge_03: Series with 5 identical elements (x,y) = (1,1)', () => {
    const dataSeries = createTSLinearSeries(5)
    dataSeries.push(1, 1)
    dataSeries.push(1, 1)
    dataSeries.push(1, 1)
  ...
  test('Edge_04: Series with 5 elements, y = x, but no weight', () => {
    const dataSeries = createTSLinearSeries(5)
