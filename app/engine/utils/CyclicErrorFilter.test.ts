...
function testRawValueAtBeginEquals (object, expectedValue) {
  assert.strictEqual(object.raw, expectedValue, `Expected raw value atSeriesBegin() to be ${expectedValue}, encountered ${object.raw}`)
}

function testCleanValueAtBeginEquals (object, expectedValue) {
  assert.strictEqual(object.clean, expectedValue, `Expected clean value atSeriesBegin() to be ${expectedValue}, encountered ${object.clean}`)
}

function testGoodnessOfFitAtBeginEquals (object, expectedValue) {
  assert.strictEqual(object.goodnessOfFit, expectedValue, `Expected goodnessOfFit atSeriesBegin() to be ${expectedValue}, encountered ${object.goodnessOfFit}`)
}
