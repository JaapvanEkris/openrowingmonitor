...
import { createCyclicErrorFilter } from './CyclicErrorFilter.ts'
import { createTSLinearSeries } from './TSLinearSeries.ts'

describe('Initialisation of the CECFilter', () => {
  test('Correct behaviour of the filter directly after initialisation, without filter updates, including domain filter behaviour and sync with flank', () => {
    ...
    testRawValueEquals(currentDtAtSeriesBegin, undefined)
    testCleanValueEquals(currentDtAtSeriesBegin, undefined)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 1.6)
    testCleanValueEquals(currentDtAtSeriesBegin, 1.6)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.000001)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 1.5)
    testCleanValueEquals(currentDtAtSeriesBegin, 1.5)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.000001)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 1.4)
    testCleanValueEquals(currentDtAtSeriesBegin, 1.4)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.04000000000000007)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 1.3)
    testCleanValueEquals(currentDtAtSeriesBegin, 1.3)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.15999999999999992)
    cleanCurrentDt = CECFilter.applyFilter(0.9, 12)
    testCleanValueEquals(cleanCurrentDt, 0.9)
    testGoodnessOfFitEquals(cleanCurrentDt, 1.0)
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 1.2)
    testCleanValueEquals(currentDtAtSeriesBegin, 1.2)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.3600000000000001)
    cleanCurrentDt = CECFilter.applyFilter(0.8, 13)
    testCleanValueEquals(cleanCurrentDt, 0.8)
    testGoodnessOfFitEquals(cleanCurrentDt, 1.0)
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 1.1)
    testCleanValueEquals(currentDtAtSeriesBegin, 1.1)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.6399999999999997)
    cleanCurrentDt = CECFilter.applyFilter(0.7, 14)
    testCleanValueEquals(cleanCurrentDt, 0.7)
    testGoodnessOfFitEquals(cleanCurrentDt, 1.0)
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 1.0)
    testCleanValueEquals(currentDtAtSeriesBegin, 1.0)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 1.0)
    cleanCurrentDt = CECFilter.applyFilter(0.6, 15)
    testCleanValueEquals(cleanCurrentDt, 0.6)
    testGoodnessOfFitEquals(cleanCurrentDt, 1.0)
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.9)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.9)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 1.0)
    cleanCurrentDt = CECFilter.applyFilter(0.5, 16)
    testCleanValueEquals(cleanCurrentDt, 0.5)
    testGoodnessOfFitEquals(cleanCurrentDt, 1.0)
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.8)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.8)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 1.0)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.7)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.7)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 1.0)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.6)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.6)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 1.0)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.5)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.5)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 1.0)
    ...
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.4)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.4)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.6400000000000001)
    cleanCurrentDt = CECFilter.applyFilter(0.0, 21)
    testCleanValueEquals(cleanCurrentDt, 0.0)
    testGoodnessOfFitEquals(cleanCurrentDt, 0.000001)
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.3)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.3)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.36)
    cleanCurrentDt = CECFilter.applyFilter(-0.1, 22)
    testCleanValueEquals(cleanCurrentDt, -0.1)
    testGoodnessOfFitEquals(cleanCurrentDt, 0.000001)
    currentDtAtSeriesBegin = CECFilter.atSeriesBegin()
    testRawValueEquals(currentDtAtSeriesBegin, 0.2)
    testCleanValueEquals(currentDtAtSeriesBegin, 0.2)
    testGoodnessOfFitEquals(currentDtAtSeriesBegin, 0.16000000000000003)
  })
})

describe('Behaviour of updatng the CECFilter', () => {
  test('Correct behaviour of CECfilter updating to new data, agressiveness 1.0', () => {
    const baseRowerConfig = {
      numOfImpulsesPerRevolution: 2,
      flankLength: 2,
      autoAdjustDragFactor: true,
    ...
    // Initialize the Linear regressor to create a function where y = x, as a known starting point
    let i = 0
    while (i < 24) {
  ...
  test('Correct behaviour of the CECfilter in updating the filter, agressiveness 1.1', () => {
    const baseRowerConfig = {
      numOfImpulsesPerRevolution: 2,
      flankLength: 2,
      autoAdjustDragFactor: true,
...
describe('Behaviour of the CECFilter with a filter in a feedback loop', () => {
  ...
  test('Correct behaviour of the filter after exposing it to an updated filter with noisy linear regressor (2.5%), seven rounds, agressiveness 1.0, size two recoveries on a a simulated slope (y = x)', () => {
    const baseRowerConfig = {
      ...
      maximumTimeBetweenImpulses: 240
    }
    ...
    let testDataArray = []
    for (let i = 0; i < 220; i++) {
      testDataArray[i] = (i - 1) + fuzzing.systematicNoise.currentDt(i, 1)
    }
    ...
    testRegressorSlopeEquals(baseRegressionFunction, 1) // Ideal value 1.0
    testRegressorInterceptEquals(baseRegressionFunction, 0.012499999999988631) // Ideal value 0
    testRegressorGoodnessOfFitEquals(baseRegressionFunction, 0.999999887641441) // Ideal value 1
    ...
    cleanCurrentDt = []
    for (let i = 0; i < testDataArray.length; i++) {
      cleanCurrentDt[i] = CECFilter.applyFilter(testDataArray[i], (240 + i))
    }
    ...
    // Here we feed the cleaned data back in, simulating an active filter for the second round
    for (let i = 0; i < cleanCurrentDt.length; i++) {
      baseRegressionFunction.push(i + 240, cleanCurrentDt[i].clean, cleanCurrentDt[i].goodnessOfFit)
      CECFilter.recordRawDatapoint(i + 240, i + 240, testDataArray[i])
    }

    testRegressorSlopeEquals(baseRegressionFunction, 0.9999910889657787) // Ideal value 1.0
    testRegressorInterceptEquals(baseRegressionFunction, -239.99586025780172) // Ideal value -240
    testRegressorGoodnessOfFitEquals(baseRegressionFunction, 0.999999985783202) // Ideal value 1
    ...
    cleanCurrentDt = []
    for (let i = 0; i < testDataArray.length; i++) {
      cleanCurrentDt[i] = CECFilter.applyFilter(testDataArray[i], (480 + i))
    }
    ...
    // Here we feed the cleaned data back in, simulating an active filter for the third round
    for (let i = 0; i < testDataArray.length; i++) {
      baseRegressionFunction.push(i + 480, cleanCurrentDt[i].clean, cleanCurrentDt[i].goodnessOfFit)
      CECFilter.recordRawDatapoint(i + 480, i + 480, testDataArray[i])
    }

    testRegressorSlopeEquals(baseRegressionFunction, 0.9999995530155406) // Ideal value 1.0
    testRegressorInterceptEquals(baseRegressionFunction, -479.9995308877067) // Ideal value -480
    testRegressorGoodnessOfFitEquals(baseRegressionFunction, 0.9999999972938363) // Ideal value 1
    ...
    cleanCurrentDt = []
    for (let i = 0; i < testDataArray.length; i++) {
      cleanCurrentDt[i] = CECFilter.applyFilter(testDataArray[i], (720 + i))
    }
    ...
    // Here we feed the cleaned data back in, simulating an active filter for the fourth round
    for (let i = 0; i < testDataArray.length; i++) {
      baseRegressionFunction.push(i + 720, cleanCurrentDt[i].clean, cleanCurrentDt[i].goodnessOfFit)
      CECFilter.recordRawDatapoint(i + 720, i + 720, testDataArray[i])
    }

    testRegressorSlopeEquals(baseRegressionFunction, 0.9999992321613992) // Ideal value 1.0
    testRegressorInterceptEquals(baseRegressionFunction, -719.9990978248445) // Ideal value -720
    testRegressorGoodnessOfFitEquals(baseRegressionFunction, 0.9999999999788445) // Ideal value 1
    ...
    cleanCurrentDt = []
    for (let i = 0; i < testDataArray.length; i++) {
      cleanCurrentDt[i] = CECFilter.applyFilter(testDataArray[i], (960 + i))
    }
    ...
    // Here we feed the cleaned data back in, simulating an active filter for the fifth round
    for (let i = 0; i < testDataArray.length; i++) {
      baseRegressionFunction.push(i + 960, cleanCurrentDt[i].clean, cleanCurrentDt[i].goodnessOfFit)
      CECFilter.recordRawDatapoint(i + 960, i + 960, testDataArray[i])
    }

    testRegressorSlopeEquals(baseRegressionFunction, 0.9999999566932966) // Ideal value 1.0
    testRegressorInterceptEquals(baseRegressionFunction, -959.9997826972119) // Ideal value -960
    testRegressorGoodnessOfFitEquals(baseRegressionFunction, 0.999999999999899) // Ideal value 1
    ...
    cleanCurrentDt = []
    for (let i = 0; i < testDataArray.length; i++) {
      cleanCurrentDt[i] = CECFilter.applyFilter(testDataArray[i], (1200 + i))
    }
    ...
    // Here we feed the cleaned data back in, simulating an active filter for the fifth round
    for (let i = 0; i < testDataArray.length; i++) {
      baseRegressionFunction.push(i + 1200, cleanCurrentDt[i].clean, cleanCurrentDt[i].goodnessOfFit)
      CECFilter.recordRawDatapoint(i + 1200, i + 1200, testDataArray[i])
    }

    testRegressorSlopeEquals(baseRegressionFunction, 1.0000000003352463) // Ideal value 1.0
    testRegressorInterceptEquals(baseRegressionFunction, -1199.999833828458) // Ideal value -1200
    testRegressorGoodnessOfFitEquals(baseRegressionFunction, 1) // Ideal value 1
    ...
    cleanCurrentDt = []
    for (let i = 0; i < testDataArray.length; i++) {
      cleanCurrentDt[i] = CECFilter.applyFilter(testDataArray[i], (1440 + i))
    }
    ...
    // Here we feed the cleaned data back in, simulating an active filter for the fifth round
    for (let i = 0; i < testDataArray.length; i++) {
      baseRegressionFunction.push(i + 1440, cleanCurrentDt[i].clean, cleanCurrentDt[i].goodnessOfFit)
    }

    testRegressorSlopeEquals(baseRegressionFunction, 0.9999999964026225) // Ideal value 1.0
    testRegressorInterceptEquals(baseRegressionFunction, -1439.9998273457402) // Ideal value -1440
    testRegressorGoodnessOfFitEquals(baseRegressionFunction, 0.9999999999999987) // Ideal value 1
  })

  /**
   * Ideal values based on DragCalculation_01 of 'TSLinearSeries.test.ts'
   */
  test('Correct behaviour of the filter after exposing it to an updated filter with systematic noisy linear regressor (+/- 2.5%), seven rounds, agressiveness 1.0, size two recoveries on a simulated RowErg', () => {
    const baseRowerConfig = {
      numOfImpulsesPerRevolution: 6,
      flankLength: 2,
      autoAdjustDragFactor: true,
      systematicErrorAgressiveness: 1.0,
      systematicErrorNumberOfDatapoints: 440,
      minimumTimeBetweenImpulses: 0.002,
      maximumTimeBetweenImpulses: 0.02
    }

    const dragCalculation = createTSLinearSeries()
    const CECFilter = createCyclicErrorFilter(baseRowerConfig, dragCalculation)
    CECFilter.applyFilter(0, 0)
    ...
    let datapointX = 0
    for (let i = 0; i < 235; i++) {
      const yValue = (Math.PI / 3) * i
      const result = cleanSimulatorRecovery.solveY(yValue).secondIntegral
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.systematicNoise.currentDt(i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, i)
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
        CECFilter.recordRawDatapoint(i, totalTimeSpinning, cleanedCurrentDt.raw)
      }
    }

    testRegressorSlopeEquals(dragCalculation, 0.0012539925818350161) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9434613132768551) // Ideal value 0.9999980371918921

    // Process the datapoints, filling the entire array
    for (let i = 0; i < Math.ceil(235 / 2); i++) {
      CECFilter.processNextRawDatapoint()
    }
    CECFilter.clearDatapointBuffer()
    dragCalculation.reset()
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.systematicNoise.currentDt(240 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (240 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
        CECFilter.recordRawDatapoint(i + 240, totalTimeSpinning, cleanedCurrentDt.raw)
      }
    }

    testRegressorSlopeEquals(dragCalculation, 0.0012559586484609103) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9939455748854777) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.systematicNoise.currentDt(480 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (480 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
        CECFilter.recordRawDatapoint(i + 480, totalTimeSpinning, cleanedCurrentDt.raw)
      }
    }

    testRegressorSlopeEquals(dragCalculation, 0.001255996687262574) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9998276670676578) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.systematicNoise.currentDt(720 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (720 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
        CECFilter.recordRawDatapoint(i + 720, totalTimeSpinning, cleanedCurrentDt.raw)
      }
    }

    testRegressorSlopeEquals(dragCalculation, 0.0012558024264862323) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999108741242352) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.systematicNoise.currentDt(960 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (960 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
        CECFilter.recordRawDatapoint(i + 960, totalTimeSpinning, cleanedCurrentDt.raw)
      }
    }

    testRegressorSlopeEquals(dragCalculation, 0.001255845512095883) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999186184886191) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.systematicNoise.currentDt(1200 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (1200 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
        CECFilter.recordRawDatapoint(i + 1200, totalTimeSpinning, cleanedCurrentDt.raw)
      }
    }

    testRegressorSlopeEquals(dragCalculation, 0.0012561441297633366) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999195784602659) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.systematicNoise.currentDt(1440 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (1440 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
        CECFilter.recordRawDatapoint(i + 1440, totalTimeSpinning, cleanedCurrentDt.raw)
      }
    }

    testRegressorSlopeEquals(dragCalculation, 0.001256163688138178) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999195774826795) // Ideal value 1
  })

  /**
   * Ideal values based on DragCalculation_01 of 'TSLinearSeries.test.ts'
   */
  test('Correct behaviour of the filter after exposing it to an updated filter with random noisy linear regressor (+/- 2.5%), seven rounds, agressiveness 1.0, size two recoveries on a simulated RowErg', () => {
    const baseRowerConfig = {
      numOfImpulsesPerRevolution: 6,
      flankLength: 2,
      autoAdjustDragFactor: true,
    ...
    testRegressorSlopeEquals(dragCalculation, 0.0012554107307264724) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.999992407399501) // Ideal value 0.9999980371918921
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.randomNoise.currentDt(240 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (240 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
    ...
    testRegressorSlopeEquals(dragCalculation, 0.0012553828297652682) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999921180815832) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.randomNoise.currentDt(480 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (480 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
    ...
    testRegressorSlopeEquals(dragCalculation, 0.001255391464850835) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999925593094464) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.randomNoise.currentDt(720 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (720 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
    ...
    testRegressorSlopeEquals(dragCalculation, 0.001255405307275121) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999924079170468) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.randomNoise.currentDt(960 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (960 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
    ...
    testRegressorSlopeEquals(dragCalculation, 0.00125543503728514) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999919492794311) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.randomNoise.currentDt(1200 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (1200 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
    ...
    testRegressorSlopeEquals(dragCalculation, 0.0012554536671331013) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999922592520619) // Ideal value 1
    ...
    for (let i = 0; i < 235; i++) {
      ...
      if (result.x !== null && !isNaN(result.x)) {
        const cleanCurrentDt = result.x - datapointX
        const noisyCurrentDt = fuzzing.randomNoise.currentDt(1440 + i, cleanCurrentDt)
        datapointX = ((result.x - cleanCurrentDt) + noisyCurrentDt)
        const cleanedCurrentDt = CECFilter.applyFilter(noisyCurrentDt, (1440 + i))
        totalTimeSpinning += cleanedCurrentDt.clean
        dragCalculation.push(totalTimeSpinning, cleanedCurrentDt.clean, cleanedCurrentDt.goodnessOfFit)
    ...
    testRegressorSlopeEquals(dragCalculation, 0.0012553741799664717) // Ideal value 0.0012561947201753742
    testRegressorGoodnessOfFitEquals(dragCalculation, 0.9999910390502463) // Ideal value 1
  })

/* eslint-enable complexity */
})

function testCleanValueObject (object: Readonly<CECFilteredValue>, expectedValue: Readonly<Number>, expectedGoodnessOfFit: Readonly<Number>) {
  assert.strictEqual(object.clean, expectedValue, `Expected cleaned currentDt value to be ${expectedValue}, encountered ${object.clean}`)
  assert.strictEqual(object.goodnessOfFit, expectedGoodnessOfFit, `Expected goodnessOfFit to be ${expectedGoodnessOfFit}, encountered ${object.goodnessOfFit}`)
}

function testCleanValueEquals (object: Readonly<CECFilteredValue>, expectedValue: Readonly<Number>) {
  assert.strictEqual(object.clean, expectedValue, `Expected cleaned currentDt  value to be ${expectedValue}, encountered ${object.clean}`)
}

function testGoodnessOfFitEquals (object: Readonly<CECFilteredValue>, expectedValue: Readonly<Number>) {
  assert.strictEqual(object.goodnessOfFit, expectedValue, `Expected goodnessOfFit to be ${expectedValue}, encountered ${object.goodnessOfFit}`)
}

function testRawValueEquals (object: Readonly<CECFilteredValue>, expectedValue: Readonly<Number>) {
  assert.strictEqual(object.raw, expectedValue, `Expected raw value to be ${expectedValue}, encountered ${object.raw}`)
}

function testRegressorSlopeEquals (series: Readonly<TSLinearSeries>, expectedValue: Readonly<Number>) {
  assert.strictEqual(series.slope(), expectedValue, `Expected regression slope to be ${expectedValue}, encountered a ${series.slope()}`)
}

function testRegressorInterceptEquals (series: Readonly<TSLinearSeries>, expectedValue: Readonly<Number>) {
  assert.strictEqual(series.intercept(), expectedValue, `Expected regression intercept to be ${expectedValue}, encountered ${series.intercept()}`)
}

function testRegressorGoodnessOfFitEquals (series: Readonly<TSLinearSeries>, expectedValue: Readonly<Number>) {
  assert.strictEqual(series.goodnessOfFit(), expectedValue, `Expected regression goodnessOfFit to be ${expectedValue}, encountered ${series.goodnessOfFit()}`)
}
