...
function testGetX (series, position, expectedValue) {
...
function testGetY (series, position, expectedValue) {
...
function testSlopeAbove (series, expectedValue) {
...
function testGoodnessOfFitAbove (series, expectedValue) {
