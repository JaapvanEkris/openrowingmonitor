...
describe('Initialisation of the TSQuadraticSeries object', () => {
  /**
   * This series of tests focusses on testing the reliability of the quadratic estimator algorithm
   */
  test('Correct behaviour of a TSQuadratic series after initialisation', () => {
    ...
    testCoefficientC(dataSeries, undefined)
    testFirstDerivativeAtPosition(dataSeries, 0, undefined)
    testSecondDerivativeAtPosition(dataSeries, 0, undefined)
    testSlope(dataSeries, 0, undefined)
    testIntercept(dataSeries, 0, undefined)
    testGoodnessOfFitEquals(dataSeries, undefined)
    testLocalGoodnessOfFit(dataSeries, 0, undefined)
    testXProjectionEquals(dataSeries, 1, undefined)
  })

  test('TS Quadratic behaviour after one data push', () => {
    const dataSeries = createTSQuadraticSeries(10)
    dataSeries.push(-1, 2)
    ...
    testIsReliable(dataSeries, false)
    testGetX(dataSeries, 0, -1)
    testGetY(dataSeries, 0, 2)
    testXAtSeriesBegin(dataSeries, -1)
    testYAtSeriesBegin(dataSeries, 2)
    testXAtSeriesEnd(dataSeries, -1)
    testYAtSeriesEnd(dataSeries, 2)
    testNumberOfXValuesAbove(dataSeries, 0, 0)
    testNumberOfYValuesAbove(dataSeries, 0, 1)
    testNumberOfXValuesEqualOrBelow(dataSeries, 0, 1)
    ...
    testXSum(dataSeries, -1)
    testYSum(dataSeries, 2)
    testAverageX(dataSeries, -1)
    testAverageY(dataSeries, 2)
    testMinimumX(dataSeries, -1)
    testMinimumY(dataSeries, 2)
    testMaximumX(dataSeries, -1)
    testMaximumY(dataSeries, 2)
    testMedianX(dataSeries, -1)
    testMedianY(dataSeries, 2)
    testXSeries(dataSeries, [-1])
    testYSeries(dataSeries, [2])
    testCoefficientA(dataSeries, undefined)
    testCoefficientB(dataSeries, undefined)
    testCoefficientC(dataSeries, undefined)
    testFirstDerivativeAtPosition(dataSeries, 0, undefined)
    ...
    testGoodnessOfFitEquals(dataSeries, undefined)
    testLocalGoodnessOfFit(dataSeries, 0, undefined)
    testXProjectionEquals(dataSeries, 0, undefined)
  })

  test('TS Quadratic behaviour after two data pushes', () => {
    const dataSeries = createTSQuadraticSeries(10)
    dataSeries.push(-1, 2)
    dataSeries.push(0, 2)
    ...
    testGetX(dataSeries, 0, -1)
    testGetY(dataSeries, 0, 2)
    testGetX(dataSeries, 1, 0)
    testGetY(dataSeries, 1, 2)
    testXAtSeriesBegin(dataSeries, -1)
    testYAtSeriesBegin(dataSeries, 2)
    ...
    testNumberOfXValuesEqualOrBelow(dataSeries, 0, 2)
    testNumberOfYValuesEqualOrBelow(dataSeries, 0, 0)
    testNumberOfXValuesAbove(dataSeries, 10, 0)
    testNumberOfYValuesAbove(dataSeries, 10, 0)
    ...
    testXSum(dataSeries, -1)
    testYSum(dataSeries, 4)
    testAverageX(dataSeries, -0.5)
    testAverageY(dataSeries, 2)
    testMinimumX(dataSeries, -1)
    testMinimumY(dataSeries, 2)
    testMaximumX(dataSeries, 0)
    testMaximumY(dataSeries, 2)
    testMedianX(dataSeries, -0.5)
    testMedianY(dataSeries, 2)
    testXSeries(dataSeries, [-1, 0])
    testYSeries(dataSeries, [2, 2])
    testCoefficientA(dataSeries, undefined)
    testCoefficientB(dataSeries, undefined)
    testCoefficientC(dataSeries, undefined)
    testFirstDerivativeAtPosition(dataSeries, 0, undefined)
  ...
  test('TS Quadratic behaviour after three data pushes', () => {
    const dataSeries = createTSQuadraticSeries(10)
    dataSeries.push(-1, 2)
    dataSeries.push(0, 2)
    dataSeries.push(1, 6)
    ...
    testYSum(dataSeries, 10)
    testAverageX(dataSeries, 0)
    testAverageY(dataSeries, 3.3333333333333335)
    testMinimumX(dataSeries, -1)
    testMinimumY(dataSeries, 2)
    testMaximumX(dataSeries, 1)
    testMaximumY(dataSeries, 6)
    testMedianX(dataSeries, 0)
    testMedianY(dataSeries, 2)
    testXSeries(dataSeries, [-1, 0, 1])
    testYSeries(dataSeries, [2, 2, 6])
    testCoefficientA(dataSeries, 2)
    testCoefficientB(dataSeries, 2)
    testCoefficientC(dataSeries, 2)
    testFirstDerivativeAtPosition(dataSeries, 0, -2)
    testSecondDerivativeAtPosition(dataSeries, 0, 4)
    testFirstDerivativeAtPosition(dataSeries, 1, 2)
    testSecondDerivativeAtPosition(dataSeries, 1, 4)
    testFirstDerivativeAtPosition(dataSeries, 2, 6)
    testSecondDerivativeAtPosition(dataSeries, 2, 4)
    testSlope(dataSeries, -1, -2)
    testIntercept(dataSeries, -1, 0)
    testSlope(dataSeries, 0, 2)
    testIntercept(dataSeries, 0, 2)
    testSlope(dataSeries, 1, 6)
    testIntercept(dataSeries, 1, 0)
    ...
    testXProjectionEquals(dataSeries, -1, 2)
...
describe('Test behaviour of the TSQuadraticSeries object when data is pushed', () => {
  /**
   * @description Test behaviour for a series of datapoints
...
describe('Test behaviour of the TSQuadraticSeries object when data is pushed and pushed out again', () => {
  /**
   * @description Data based on 2 x^2 + 2 x + 2, split the dataset in two to see its behaviour when it is around the Vertex
   */
  ...
  /**
   * @description Data based on 4 x^2 + 4 x + 4
   */
...
describe('Test behaviour of the TSQuadraticSeries object with external test cases with reference results', () => {
  /**
   * @description Data based on https://mathbits.com/MathBits/TISection/Statistics2/quadratic.html
   */
  ...
  /**
   * @description Test based on https://www.varsitytutors.com/hotmath/hotmath_help/topics/quadratic-regression
   */
  ...
  /**
   * @description Test based on https://www.vtupulse.com/machine-learning/quadratic-polynomial-regression-model-solved-example/
   */
  ...
  /**
   * @description Test based on https://www.geo.fu-berlin.de/en/v/soga/Basics-of-statistics/Linear-Regression/Polynomial-Regression/Polynomial-Regression---An-example/index.html
   */
  ...
  /**
   * @description Test based on https://www.statology.org/quadratic-regression-r/
   */
  ...
  /**
   * @description Test based on https://www.statsdirect.com/help/regression_and_correlation/polynomial.htm
   */
...
describe('Test behaviour of the TSQuadraticSeries object after a reset', () => {
  /**
   * @description Data based on 2 x^2 + 2 x + 2
   */
...
describe('Test of edge cases in the TSQuadraticSeries object', () => {
  /**
   * @description As ORM will encounter straight lines (when forces are balanced on the flywheel, there is no acceleration/deceleration), so we need to test this as well
   */
  test('Edge_01: Quadratic TS Estimation should result in a straight line for function y = x', () => {
    const dataSeries = createTSQuadraticSeries(7)
    dataSeries.push(0, 0)
    dataSeries.push(1, 1)
    dataSeries.push(2, 2)
  ...
  test('Edge_02: Series with 5 elements, on the horizontal line y = 6', () => {
    const dataSeries = createTSQuadraticSeries(5)
    dataSeries.push(1, 6)
    dataSeries.push(2, 6)
    dataSeries.push(3, 6)
  ...
  test('Edge_03: Series with 5 elements on the vertical line x = 6', () => {
    const dataSeries = createTSQuadraticSeries(5)
    dataSeries.push(6, 1)
    dataSeries.push(6, 2)
    dataSeries.push(6, 3)
    ...
    testCoefficientC(dataSeries, undefined)
    testLocalGoodnessOfFit(dataSeries, 0, undefined)
    testLocalGoodnessOfFit(dataSeries, 1, undefined)
    testLocalGoodnessOfFit(dataSeries, 2, undefined)
    testLocalGoodnessOfFit(dataSeries, 3, undefined)
    testLocalGoodnessOfFit(dataSeries, 4, undefined)
    testLocalGoodnessOfFit(dataSeries, 5, undefined)
  ...
  test('Edge_04: Series with 5 elements on the vertical line x = 6, after pushing out a valid series', () => {
    const dataSeries = createTSQuadraticSeries(5)
    dataSeries.push(0, 2)
    dataSeries.push(1, 6)
    dataSeries.push(2, 14)
  ...
  test('Edge_05: Series with 5 identical elements (x,y) = (1,1)', () => {
    const dataSeries = createTSQuadraticSeries(5)
    dataSeries.push(1, 1)
    dataSeries.push(1, 1)
    dataSeries.push(1, 1)
  ...
  test('Edge_06: Series with 5 identical elements (x,y) = (1,1), after pushing out a valid series', () => {
    const dataSeries = createTSQuadraticSeries(5)
    dataSeries.push(0, 2)
    dataSeries.push(1, 6)
    dataSeries.push(2, 14)
  ...
  test('Edge_07: Series with 5 elements, y = x, but no weight', () => {
    const dataSeries = createTSQuadraticSeries(5)
  ...
  test('Edge_08: Series with 5 elements, y = x, but no weight, after pushing out a valid series', () => {
    const dataSeries = createTSQuadraticSeries(5)
    dataSeries.push(0, 2, 1)
    dataSeries.push(1, 6, 1)
    dataSeries.push(2, 14, 1)
    dataSeries.push(3, 26, 1)
    dataSeries.push(4, 42, 1)
    testIsReliable(dataSeries, true)
    testCoefficientA(dataSeries, 2)
    testCoefficientB(dataSeries, 2)
    testCoefficientC(dataSeries, 2)
...
describe('Test behaviour of the TSQuadraticSeries object in larger datasets', () => {
  test('STRESS_Theoretical_01: Infinite series with 500 noiseless datapoints, ideal function y = x^2, uniform weights', () => {
    // Please note: this noiseless data results in +/- 0.3 * (500^3) identical A's. This stress-tests the balancing of the trees (otherwise it will result in a heap overflow)
    const dataSeries = createTSQuadraticSeries()

    let j = 0
    while (j < 500) {
      dataSeries.push(j, j * j, 1)
      j++
    }

    testLength(dataSeries, 500)
    testCoefficientA(dataSeries, 1)
    testCoefficientB(dataSeries, 0)
    testCoefficientC(dataSeries, 0)
    testGoodnessOfFitEquals(dataSeries, 1)
  }, 180000) // Timeout in ms

  test('STRESS_Theoretical_02: Fininte series with 64,000 noiseless datapoints, ideal function y = x^2, uniform weights', () => {
    // Please note: this noiseless data results in +/- 0.3 * (12^3) identical A's. This stress-tests the balancing of the trees (as there are a lot of inserts and removals)
 ...
 */
describe('Test of more realistic application of the TSQuadraticSeries object', () => {
  /**
  ...
  test('Quadratic Approximation on a perfect noisefree function y = 2 * Math.pow(x, 2) + 4 * x + 2, 32 datapoints', () => {
    ...
    testSecondDerivativeAtPosition(dataSeries, 0, undefined)
    testLocalGoodnessOfFit(dataSeries, 0, undefined)
    testFirstDerivativeAtPosition(dataSeries, 1, undefined)
    testSecondDerivativeAtPosition(dataSeries, 1, undefined)
    testLocalGoodnessOfFit(dataSeries, 1, undefined)
...
function testLength (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.length(), expectedValue, `Expected length at X-position ${series.X.atSeriesEnd()} should be ${expectedValue}, encountered a ${series.length()}`)
}

function testGetX (series: Readonly<TSLinearSeries>, position: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.get(position), expectedValue, `Expected X.get(${position}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.get(position)}`)
}

function testGetY (series: Readonly<TSLinearSeries>, position: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.get(position), expectedValue, `Expected X.get(${position}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.get(position)}`)
}

function testXAtSeriesBegin (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.atSeriesBegin(), expectedValue, `Expected X.atSeriesBegin at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.atSeriesBegin()}`)
}

function testYAtSeriesBegin (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.atSeriesBegin(), expectedValue, `Expected Y.atSeriesBegin at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.atSeriesBegin()}`)
}

function testXAtSeriesEnd (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.atSeriesEnd(), expectedValue, `Expected X.atSeriesEnd at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.atSeriesEnd()}`)
}

function testYAtSeriesEnd (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.atSeriesEnd(), expectedValue, `Expected Y.atSeriesEnd at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.atSeriesEnd()}`)
}

function testNumberOfXValuesAbove (series: Readonly<TSLinearSeries>, cutoff: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.numberOfValuesAbove(cutoff), expectedValue, `Expected X.numberOfValuesAbove(${cutoff}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.numberOfValuesAbove(cutoff)}`)
}

function testNumberOfYValuesAbove (series: Readonly<TSLinearSeries>, cutoff: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.numberOfValuesAbove(cutoff), expectedValue, `Expected Y.numberOfValuesAbove(${cutoff}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.numberOfValuesAbove(cutoff)}`)
}
...
function testNumberOfXValuesEqualOrBelow (series: Readonly<TSLinearSeries>, cutoff: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.numberOfValuesEqualOrBelow(cutoff), expectedValue, `Expected X.numberOfValuesEqualOrBelow(${cutoff}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.numberOfValuesEqualOrBelow(cutoff)}`)
}
...
function testNumberOfYValuesEqualOrBelow (series: Readonly<TSLinearSeries>, cutoff: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.numberOfValuesEqualOrBelow(cutoff), expectedValue, `Expected Y.numberOfValuesEqualOrBelow(${cutoff}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.numberOfValuesEqualOrBelow(cutoff)}`)
}

function testXSum (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.sum(), expectedValue, `Expected X.sum at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.sum()}`)
}

function testYSum (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.sum(), expectedValue, `Expected Y.sum at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.sum()}`)
}

function testAverageX (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.average(), expectedValue, `Expected X.average at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.average()}`)
}

function testAverageY (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.average(), expectedValue, `Expected Y.average at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.average()}`)
}

function testMinimumX (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.minimum(), expectedValue, `Expected X.minimum at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.minimum()}`)
}

function testMinimumY (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.minimum(), expectedValue, `Expected Y.minimum at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.minimum()}`)
}

function testMaximumX (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.maximum(), expectedValue, `Expected X.maximum at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.maximum()}`)
}

function testMaximumY (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.maximum(), expectedValue, `Expected Y.maximum at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.maximum()}`)
}

function testMedianX (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.median(), expectedValue, `Expected X.median at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.median()}`)
}

function testMedianY (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.median(), expectedValue, `Expected Y.median at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.median()}`)
}
function testXSeries (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number[]>) {
  assert.strictEqual(series.X.series().toString(), expectedValue.toString(), `Expected X.series at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.series()}`)
}

function testYSeries (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number[]>) {
  assert.strictEqual(series.Y.series().toString(), expectedValue.toString(), `Expected Y.series at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.series()}`)
}
function testXLength (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.X.length(), expectedValue, `Expected X.length at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.X.length()}`)
}

function testYLength (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.Y.length(), expectedValue, `Expected Y.length at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.Y.length()}`)
}

function testSlope (series: Readonly<TSLinearSeries>, position: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.slope(position), expectedValue, `Expected slope(${position}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered a ${series.slope(position)}`)
}

function testIntercept (series: Readonly<TSLinearSeries>, position: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.intercept(position), expectedValue, `Expected intercept(${position}) at X-position ${series.X.atSeriesEnd()} to be ${expectedValue}, encountered ${series.intercept(position)}`)
}

function testCoefficientA (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.coefficientA(), expectedValue, `Expected value for coefficientA at X-position ${series.X.atSeriesEnd()} is ${expectedValue}, encountered a ${series.coefficientA()}`)
}

function testCoefficientB (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.coefficientB(), expectedValue, `Expected value for coefficientB at X-position ${series.X.atSeriesEnd()} is ${expectedValue}, encountered a ${series.coefficientB()}`)
}

function testCoefficientC (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.coefficientC(), expectedValue, `Expected value for coefficientC at X-position ${series.X.atSeriesEnd()} is ${expectedValue}, encountered a ${series.coefficientC()}`)
}

function testGoodnessOfFitEquals (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.goodnessOfFit(), expectedValue, `Expected goodnessOfFit at X-position ${series.X.atSeriesEnd()} is ${expectedValue}, encountered ${series.goodnessOfFit()}`)
}

function testLocalGoodnessOfFit (series: Readonly<TSLinearSeries>, position: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.localGoodnessOfFit(position), expectedValue, `Expected localGoodnessOfFit at X-position ${series.X.atSeriesEnd()} for position ${position} to be ${expectedValue}, encountered ${series.localGoodnessOfFit(position)}`)
}

function testFirstDerivativeAtPosition (series: Readonly<TSLinearSeries>, position: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.firstDerivativeAtPosition(position), expectedValue, `Expected value for first derivative for position ${position} at X-position ${series.X.atSeriesEnd()} is ${expectedValue}, encountered a ${series.firstDerivativeAtPosition(position)}`)
}

function testSecondDerivativeAtPosition (series: Readonly<TSLinearSeries>, position: Readonly<number>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.secondDerivativeAtPosition(position), expectedValue, `Expected value for second derivative for position ${position} at X-position ${series.X.atSeriesEnd()} is ${expectedValue}, encountered a ${series.secondDerivativeAtPosition(position)}`)
}

function testXProjectionEquals (series, xValue, expectedValue) {
  assert.strictEqual(series.projectX(xValue), expectedValue, `Expected projectX at X-position ${series.X.atSeriesEnd()} for x value ${xValue} to be y = ${expectedValue}, encountered ${series.projectX(xValue)}`)
}

function testIsReliable (series: Readonly<TSLinearSeries>, expectedValue: Readonly<number>) {
  assert.strictEqual(series.reliable(), expectedValue, `Expected value for isReliable at X-position ${series.X.atSeriesEnd()} is ${expectedValue}, encountered a ${series.reliable()}`)
}
