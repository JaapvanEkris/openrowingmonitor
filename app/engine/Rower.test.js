...
test('Test behaviour for three perfect identical strokes, including settingling behaviour of metrics', () => {
  ...
  testDrivePeakHandleForce(rower, 325.22158666589513)
  testRecoveryDuration(rower, undefined)
  testRecoveryDragFactor(rower, undefined)
  testInstantHandlePower(rower, 0)
  ...
  testTotalLinearDistanceSinceStart(rower, 1.79322327251811)
  ...
  testCycleLinearVelocity(rower, 4.334810434293682)
  testCyclePower(rower, 228.0701045227182)
  testDriveDuration(rower, 0.143485717)
  testDriveLinearDistance(rower, 0.43908201661387253)
  testDriveLength(rower, 0.1759291886010284)
  testDriveAverageHandleForce(rower, 236.59565919132677)
  testDrivePeakHandleForce(rower, 380.1396291775697)
  testRecoveryDuration(rower, 0.20540926600000003)
  testRecoveryDragFactor(rower, 283.12720365097886)
  testInstantHandlePower(rower, 504.63601532767433)
  ...
  testTotalLinearDistanceSinceStart(rower, 2.5250266335412315)
  testTotalNumberOfStrokes(rower, 2)
  ...
  testDriveAverageHandleForce(rower, 285.0926572298846)
  testDrivePeakHandleForce(rower, 439.7408867361311)
  testRecoveryDuration(rower, 0.20540926600000003)
  ...
  testTotalLinearDistanceSinceStart(rower, 3.4519775575038514)
  testTotalNumberOfStrokes(rower, 3)
  testCycleDuration(rower, 0.3379838680000002)
  testCycleLinearDistance(rower, 1.0245247054323698)
  ...
  testDriveLength(rower, 0.322536845768552)
  testDriveAverageHandleForce(rower, 194.28483760073857)
  testDrivePeakHandleForce(rower, 380.1396291761609)
  testRecoveryDuration(rower, 0.09812447700000015)
  testRecoveryDragFactor(rower, 283.12720365097886)
  testInstantHandlePower(rower, 504.6360153258613)
  ...
  testTotalLinearDistanceSinceStart(rower, 4.183780918526971)
  testTotalNumberOfStrokes(rower, 3)
  testCycleDuration(rower, 0.3712367640000004)
  testCycleLinearDistance(rower, 1.3172460498416174)
  testCycleLinearVelocity(rower, 4.468184312116618)
  testCyclePower(rower, 249.7763239131315)
  ...
  testDriveAverageHandleForce(rower, 254.9147916124864)
  testDrivePeakHandleForce(rower, 439.74088673494447)
  testRecoveryDuration(rower, 0.09812447700000015)
  testRecoveryDragFactor(rower, 283.12720365097886)
  testInstantHandlePower(rower, 0)
  ...
  testTotalNumberOfStrokes(rower, 3)
  testTotalLinearDistanceSinceStart(rower, 4.818010498080344)
...
test('A full session for SportsTech WRX700 should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 8406.08422954542)
...
test('A full session for a Concept2 RowErg should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 2027.4627564399068)
