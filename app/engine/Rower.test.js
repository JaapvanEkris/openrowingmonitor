...
test('Test behaviour for three perfect identical strokes, including settingling behaviour of metrics', () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 1.632062037823364)
  testTotalNumberOfStrokes(rower, 2)
  testCycleDuration(rower, 0.36002684500000004)
  testCycleLinearDistance(rower, 0.9912765399109378)
  testCycleLinearVelocity(rower, 3.361895436347019)
  testCyclePower(rower, 106.3924074515774)
  testDriveDuration(rower, 0.18585070100000003)
  testDriveLinearDistance(rower, 0.42168943065544806)
  testDriveLength(rower, 0.2638937829015426)
  testDriveAverageHandleForce(rower, 311.71040052147094)
  testDrivePeakHandleForce(rower, 419.5476735421232)
  testRecoveryDuration(rower, 0.174176144)
  testRecoveryDragFactor(rower, 357.09220007725366)
  testInstantHandlePower(rower, 557.0006605193361)
  ...
  testTotalLinearDistanceSinceStart(rower, 2.4227297203023284)
  testTotalNumberOfStrokes(rower, 2)
  testCycleDuration(rower, 0.36002684500000004)
  testCycleLinearDistance(rower, 1.7819442223899022)
  testCycleLinearVelocity(rower, 3.361895436347019)
  testCyclePower(rower, 106.3924074515774)
  testDriveDuration(rower, 0.18585070100000003)
  testDriveLinearDistance(rower, 1.2123571131344124)
  testDriveLength(rower, 0.2638937829015426)
  testDriveAverageHandleForce(rower, 321.3624003983137)
  testDrivePeakHandleForce(rower, 513.9568545390476)
  testRecoveryDuration(rower, 0.174176144)
  testRecoveryDragFactor(rower, 357.09220007725366)
  testInstantHandlePower(rower, 17.123762811950446)
