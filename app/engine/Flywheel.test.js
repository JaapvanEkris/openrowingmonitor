...
test('Correct Flywheel behaviour for a noisefree stroke', () => {
  ...
  testTorque(flywheel, 3.7294957611643182)
  testDragFactor(flywheel, 0.00011)
  testIsDwelling(flywheel, false)
  testIsUnpowered(flywheel, false)
  testIsPowered(flywheel, true)
  ...
  testAngularAcceleration(flywheel, -31.853758086688096)
  testTorque(flywheel, -2.2588295914692456)
  ...
  testAngularVelocity(flywheel, 50.091300182418095)
  testAngularAcceleration(flywheel, -11.668957417188327)
  testTorque(flywheel, -0.9159819063223209)
  testDragFactor(flywheel, 0.0001)
