...
- **Improvement of Bluetooth stability**: we moved away from @abandonware's BLE implementation and moved to @stoprocent's, as that package is better maintained and works better with newer installs of BlueZ, which should fix issues on Raspberry Pi Bookworm
