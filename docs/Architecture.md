...
B(server.js) -->|currentDt| N(SessionManager.js)
N(SessionManager.js) -->|Rowing metrics| B(server.js)
N(SessionManager.js) -->|currentDt| D(RowingStatistics.js)
D(RowingStatistics.js) -->|Rowing metrics| N(SessionManager.js)
